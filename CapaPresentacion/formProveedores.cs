...
namespace CapaPresentacion
{
    public partial class formProveedores : Form
    {
        ...
        private void frmProveedores_Load(object sender, EventArgs e)
        {
            ...
            {
                dgvdatos.Rows.Add(new object[] {"",item.IdProveedor,item.Documento,item.RazonSocial,item.Correo,item.Telefono,
        ...
        private void InitializePlaceholders()
        {
            ...
            SetPlaceholder(txtrazonsocial, "RAZON SOCIAL");
            ...
            txtrazonsocial.Enter += (s, e) => RemovePlaceholder(txtrazonsocial, "RAZON SOCIAL");
            txtrazonsocial.Leave += (s, e) => SetPlaceholder(txtrazonsocial, "RAZON SOCIAL");
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            if (obj.IdProveedor == 0)
            {
                ...
                if (idgenerado != 0)
                {
                    ...
                    dgvdatos.Rows.Add(new object[] {"",idgenerado,txtdocumento.Text,txtrazonsocial.Text,txtcorreo.Text,txttelefono.Text,
        ...
        private void dgvdatos_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgvdatos.Columns[e.ColumnIndex].Name == "btnseleccionar")
            {
                ...
                if (indice >= 0)
                {
                    ...
                    txtrazonsocial.Text = dgvdatos.Rows[indice].Cells["RazonSocial"].Value.ToString();
        ...
        private void btnexporterexcel_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                savefile.FileName = string.Format("ReportedeProveedores_{0}.xlsx", DateTime.Now.ToString("ddMMyyy"));
                ...
                if (savefile.ShowDialog() == DialogResult.OK)
                {
                    ...
                    try
                    {
                        ...
                        MessageBox.Show("El Reporte de Proveedores ha sido Generado", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Information);
